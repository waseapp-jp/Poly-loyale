...
const RemotePlayer = React.memo(function RemotePlayer({ id }: { id: string }) {
  ...
  return (
    <group ref={ref}>
      <group ref={innerRef}>
        {/* Body */}
        <mesh geometry={sharedBodyGeo} material={bodyMat} position={[0, 0, 0]} castShadow receiveShadow />
        
        {/* Eyes / Visor */}
        <mesh geometry={sharedVisorGeo} material={sharedVisorMat} position={[0, 0.5, -0.4]} castShadow />

        {/* 3D Glider */}
        <group ref={gliderRef} position={[0, 1.6, -0.2]} visible={false}>
          <mesh geometry={sharedGliderWingGeo} material={gliderWingMatsLocal} castShadow />
          <mesh geometry={sharedGliderTipGeo} material={sharedGliderTipMat} position={[1.7, 0.2, 0]} rotation={[0, 0, -0.3]} castShadow />
          <mesh geometry={sharedGliderTipGeo} material={sharedGliderTipMat} position={[-1.7, 0.2, 0]} rotation={[0, 0, 0.3]} castShadow />
          <mesh geometry={sharedGliderStrutGeo} material={sharedGliderStrutMat} position={[0, -0.6, 0]} castShadow />
        </group>
        ...
        <group ref={weaponRef} position={[0.45, 0.1, -0.3]}>
          {characterClass === 'sword' ? (
            <group rotation={[-0.4, 0.2, -0.2]}>
              <mesh geometry={sharedSwordHiltGeo} material={sharedSwordHiltMat} position={[0, -0.3, 0]} castShadow />
              <mesh geometry={sharedSwordGuardGeo} material={sharedSwordGuardMat} position={[0, -0.1, 0]} castShadow />
              <mesh geometry={sharedSwordBladeGeo} material={sharedSwordBladeMat} position={[0, 0.8, 0]} castShadow />
              <mesh geometry={sharedSwordEdgeGeo} material={sharedSwordEdgeMat} position={[0.03, 0.8, 0]} castShadow />
            </group>
          ) : (
            <group position={[0, 0, 0]}>
              <mesh geometry={sharedGunBodyGeo} material={sharedGunBodyMat} position={[0, 0, 0]} castShadow />
              <mesh geometry={sharedGunBarrelGeo} material={sharedGunBarrelMat} position={[0, 0.04, -0.45]} rotation={[Math.PI / 2, 0, 0]} castShadow />
              <mesh geometry={sharedGunAccentGeo} material={weaponAccentMat} position={[0, 0.12, -0.05]} castShadow />
            </group>
          )}
        </group>
      </group>
