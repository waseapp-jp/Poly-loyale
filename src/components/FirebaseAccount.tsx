        ...
        <div className="fixed inset-0 bg-black/75 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-2xl p-6 shadow-2xl relative text-left max-h-[90vh] flex flex-col">
            ...
            <div className="mb-4 bg-slate-800/60 rounded-xl p-2.5 border border-slate-700/60">
              ...
              <div className="flex items-center gap-1.5 overflow-x-auto pb-2 pt-0.5 allow-scroll-x scrollbar-thin">
                {ALL_RANKS.map((tier) => (
                  <RankTierPill
                    key={tier}
                    tier={tier}
        ...
        <div className="fixed inset-0 bg-black/75 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-md p-6 shadow-2xl relative text-left">
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <h3 className="text-xl font-black text-white">🏆 レートランキング (RP Leaderboard)</h3>
                <p className="text-xs text-slate-400">レーティング（RP）順のトップランカー</p>
              </div>
            </div>
                      ...
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          ...
                          <div className="text-[10px] text-slate-400 flex items-center gap-1.5">
                            <span>{entry.totalWins || 0}勝</span>
                            <span>•</span>
                            <span>⚔️ {entry.totalKills || 0}キル</span>
                          </div>
                        </div>
                      </div>
